    ...
    <div class="container p-4">
        <div class="row my-3">
            <div class="card my-2" style="width: 18rem; margin: auto;">
                <img src="../../assets/Yesorno-bro.png" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="card my-2" style="width: 18rem; margin: auto;">
                <img src="../../assets/Visual-data-bro.png" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="card my-2" style="width: 18rem; margin: auto;">
                <img src="../../assets/Admin-pana.png" class="card-img-top" alt="...">
                <div class="card-body">
